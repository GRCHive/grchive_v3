...
def load_manual_deps():
    pass

def load_golang_deps():
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IaAsq5JY49GhDgCUKY87mo6JeOLOwp321iEP/SQjJKE=",
        version = "v0.7.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Lq4llNryJoaVFRmvrIwC/ZHH7tNt4tUYIu8+se2aayY=",
        version = "v0.0.0-20200804131852-c06518451d9c",
    )
    go_repository(
